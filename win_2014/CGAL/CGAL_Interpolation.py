...
class Double_and_bool(_object):
    ...
    if _newclass:first = _swig_property(_CGAL_Interpolation.Double_and_bool_first_get, _CGAL_Interpolation.Double_and_bool_first_set)
    ...
    if _newclass:second = _swig_property(_CGAL_Interpolation.Double_and_bool_second_get, _CGAL_Interpolation.Double_and_bool_second_set)
...
class Double_bool_bool(_object):
    ...
    if _newclass:first = _swig_property(_CGAL_Interpolation.Double_bool_bool_first_get, _CGAL_Interpolation.Double_bool_bool_first_set)
    ...
    if _newclass:second = _swig_property(_CGAL_Interpolation.Double_bool_bool_second_get, _CGAL_Interpolation.Double_bool_bool_second_set)
    ...
    if _newclass:third = _swig_property(_CGAL_Interpolation.Double_bool_bool_third_get, _CGAL_Interpolation.Double_bool_bool_third_set)
    def __init__(self, *args): 
        this = _CGAL_Interpolation.new_Double_bool_bool(*args)
        try: self.this.append(this)
        except: self.this = this
    def deepcopy(self, *args): return _CGAL_Interpolation.Double_bool_bool_deepcopy(self, *args)
...
class Point_2_and_double(_object):
    ...
    if _newclass:first = _swig_property(_CGAL_Interpolation.Point_2_and_double_first_get, _CGAL_Interpolation.Point_2_and_double_first_set)
    ...
    if _newclass:second = _swig_property(_CGAL_Interpolation.Point_2_and_double_second_get, _CGAL_Interpolation.Point_2_and_double_second_set)
    def __len__(self): return 2
    def __repr__(self): return str((self.first, self.second))
    def __getitem__(self, index): 
      if not (index % 2): 
...
class Weighted_point_2_and_double(_object):
    ...
    if _newclass:first = _swig_property(_CGAL_Interpolation.Weighted_point_2_and_double_first_get, _CGAL_Interpolation.Weighted_point_2_and_double_first_set)
    ...
    if _newclass:second = _swig_property(_CGAL_Interpolation.Weighted_point_2_and_double_second_get, _CGAL_Interpolation.Weighted_point_2_and_double_second_set)
    def __len__(self): return 2
    def __repr__(self): return str((self.first, self.second))
    def __getitem__(self, index): 
      if not (index % 2): 
...
class Point_3_and_double(_object):
    ...
    if _newclass:first = _swig_property(_CGAL_Interpolation.Point_3_and_double_first_get, _CGAL_Interpolation.Point_3_and_double_first_set)
    ...
    if _newclass:second = _swig_property(_CGAL_Interpolation.Point_3_and_double_second_get, _CGAL_Interpolation.Point_3_and_double_second_set)
    def __len__(self): return 2
    def __repr__(self): return str((self.first, self.second))
    def __getitem__(self, index): 
      if not (index % 2): 
...
class Data_access_double_2(_object):
    ...
    def set(self, *args): return _CGAL_Interpolation.Data_access_double_2_set(self, *args)
    def get(self, *args): return _CGAL_Interpolation.Data_access_double_2_get(self, *args)
...
class Data_access_vector_2(_object):
    ...
    def set(self, *args): return _CGAL_Interpolation.Data_access_vector_2_set(self, *args)
    def get(self, *args): return _CGAL_Interpolation.Data_access_vector_2_get(self, *args)
...
def linear_interpolation(*args):
  return _CGAL_Interpolation.linear_interpolation(*args)
linear_interpolation = _CGAL_Interpolation.linear_interpolation

def quadratic_interpolation(*args):
  return _CGAL_Interpolation.quadratic_interpolation(*args)
quadratic_interpolation = _CGAL_Interpolation.quadratic_interpolation

def sibson_c1_interpolation(*args):
  return _CGAL_Interpolation.sibson_c1_interpolation(*args)
sibson_c1_interpolation = _CGAL_Interpolation.sibson_c1_interpolation

def sibson_c1_interpolation_square(*args):
  return _CGAL_Interpolation.sibson_c1_interpolation_square(*args)
sibson_c1_interpolation_square = _CGAL_Interpolation.sibson_c1_interpolation_square

def farin_c1_interpolation(*args):
  return _CGAL_Interpolation.farin_c1_interpolation(*args)
farin_c1_interpolation = _CGAL_Interpolation.farin_c1_interpolation

def sibson_gradient_fitting(*args):
  return _CGAL_Interpolation.sibson_gradient_fitting(*args)
sibson_gradient_fitting = _CGAL_Interpolation.sibson_gradient_fitting

def sibson_gradient_fitting_nn_2(*args):
  return _CGAL_Interpolation.sibson_gradient_fitting_nn_2(*args)
sibson_gradient_fitting_nn_2 = _CGAL_Interpolation.sibson_gradient_fitting_nn_2

def sibson_gradient_fitting_rn_2(*args):
  return _CGAL_Interpolation.sibson_gradient_fitting_rn_2(*args)
